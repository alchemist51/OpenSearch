...
public class IndexSortPropagationIT extends OpenSearchIntegTestCase {
    ...
    private void createAndSeedBothIndices() {
        createIndex(IDX_UNSORTED, /*sortFields*/ null, /*sortOrders*/ null);
        createIndex(IDX_SORTED, List.of("CounterID", "EventDate"), List.of("desc", "desc"));
        seed(IDX_UNSORTED);
        seed(IDX_SORTED);
    }

    private void createIndex(String name, List<String> sortFields, List<String> sortOrders) {
