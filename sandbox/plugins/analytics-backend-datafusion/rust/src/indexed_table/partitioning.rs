...
/// Strategy for assigning row groups to DataFusion partitions. The bitmap path uses
/// `RowGroupBalanced` — RG-streaming wants sub-segment granularity to keep per-RG memory
/// bounded.
