...
public class DataFusionStatsPropertyTests extends OpenSearchTestCase {
    ...
    private SearchStats randomSearchStats() {
        return new SearchStats(
            nonNegLong(), nonNegLong(), nonNegLong(), nonNegLong(),
            nonNegLong(), nonNegLong(), nonNegLong(), nonNegLong(),
            nonNegLong(), nonNegLong(), nonNegLong(), nonNegLong(),
            nonNegLong(), nonNegLong()
        );
    }
    ...
    private DataFusionStats randomDataFusionStatsCpuPresent() {
        return new DataFusionStats(
            ...
            new PartitionGateStats("datanode_gate", nonNegLong(), nonNegLong(), nonNegLong(), nonNegLong()),
            new PartitionGateStats("coordinator_gate", nonNegLong(), nonNegLong(), nonNegLong(), nonNegLong()),
            randomCacheStats(),
            randomSearchStats()
        );
    }
    ...
    private DataFusionStats dataFusionStatsNullExecutors() {
        return new DataFusionStats(null, null, null, null, null);
    }
