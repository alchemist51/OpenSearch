...
public final class StatsLayout {
    ...
    private static final String[] CACHE_GROUP_FIELDS = {
        "hit_count",
        "miss_count",
        "entry_count",
        "memory_bytes",
    ...
    private static final VarHandle SS_PARQUET_POLL_TIME_MS = handle("search_stats", "parquet_poll_time_ms");
    ...
    private static final VarHandle SS_PARQUET_TIME_MS = handle("search_stats", "parquet_time_ms");
    ...
    /**
     * Read the search_stats group (14 fields) from the segment.
     *
     * @param seg the memory segment containing the DfStatsBuffer
    ...
    public static SearchStats readSearchStats(MemorySegment seg) {
        return new SearchStats(
            ...
            (long) SS_PARQUET_POLL_TIME_MS.get(seg, 0L),
    ...
    private static StructLayout searchStatsGroup(String name) {
        return MemoryLayout.structLayout(
            ...
            ValueLayout.JAVA_LONG.withName("parquet_poll_time_ms"),
