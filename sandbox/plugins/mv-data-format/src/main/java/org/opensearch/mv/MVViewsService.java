...
public final class MVViewsService {
    ...
    public static final class TargetCreator implements ClusterStateListener {
        ...
        static String targetMapping(String definition) {
            ...
            StringBuilder sb = new StringBuilder("{\"dynamic\":\"false\",\"properties\":{");
            ...
            for (int i = 0; i < shipFields.size(); i++) {
                ...
                sb.append("\"").append(shipFields.get(i)).append("\":{\"type\":\"").append(type).append("\"},");
            }
            sb.append("\"_mv_source_generation\":{\"type\":\"long\"}");
            sb.append("}}");
            return sb.toString();
        }
    }
