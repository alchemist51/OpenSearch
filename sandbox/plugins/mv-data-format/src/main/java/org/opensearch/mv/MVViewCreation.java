...
public final class MVViewCreation {
     ...
     * background merges exactly when it is present — the generic sorted
     * data-format merge preserves the contract end-to-end (including footer
     * {@code SortingColumn} re-stamping), so compaction never breaks the
     * fold's ordering assumptions.
     */
