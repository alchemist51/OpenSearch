...
public class MVViewCreationTests extends OpenSearchTestCase {
    ...
    public void testBuildTargetSettingsMatchesStage4Contract() {
        ...
        // View-created targets always carry the state-merge strategy stamp;
        // the global merge property remains the only scheduling gate.
        assertEquals("true", s.get(MVConstants.STATE_MERGE_SETTING));
